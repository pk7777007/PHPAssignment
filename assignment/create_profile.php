...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($nameErr) && empty($emailErr) && empty($bioErr)) {
    $sql = "INSERT INTO profile (name, email, bio) VALUES ('$name', '$email', '$bio')";
    if (mysqli_query($conn, $sql)) {
      header('Location: /~Peetambar200518291/assignment');
    } else {
...
<div class="signup-container">
  <div class="container-child signup-thumbnail">
    <a class="nav-link" href="#">See Profiles</a>
    ...
    <div class="thumbnail__links">
      <div class="links">
        <div><a href="#"><i class="fa fa-globe"></i></a></div>
        <div><a href="#">
  ...
  <div class="container-child signup-form">
    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
      <div class="mb-3">
        <label for="profile-pic" class="form-label">Upload Profile pic</label>
        <input type="file" class="form-control" name="upload">
      </div>
      <div class="mb-3">
        <label for="username" class="form-label">Username</label>
        <input class="form-control" placeholder="james.bond" type="text" name="name" value="<?php echo $name; ?>">
        <span class="error"> <?php echo $nameErr; ?></span>
      </div>
      <div class="mb-3">
        <label for="email" class="form-label">Email</label>
        <input class="form-control" type="text" placeholder="james.bond@spectre.com" name="email" value="<?php echo $email; ?>">
        <span class="error"><?php echo $emailErr; ?></span>
      </div>
      <div class="mb-3">
        <label for="bio" class="form-label">Bio</label>
        <input class="form-control" placeholder="Tell us about you" name="bio" value="<?php echo $bio; ?>"> </input>
